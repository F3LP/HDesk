...
public class TelaCadUsuario extends javax.swing.JDialog {
	...
	private void initComponents() {
		...
		jLabel7.setIcon(new javax.swing.ImageIcon(
				"C:\\Users\\Felipe\\Documents\\NetBeansProjects\\HelpDesk\\src\\imagens\\logo.png")); // NOI18N
		...
		cbDepartamento.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Selecione", "Administração",
				"Diretoria", "Financeiro", "Marketing", "RH", "T.I", "Vendas" }));
		...
		cbPerfil.setModel(new javax.swing.DefaultComboBoxModel<>(
				new String[] { "Selecione", "Administrador", "Gerente", "Técnico", "Usuário", " " }));

		tfCpf.setColumns(11);
		try {
			tfCpf.setFormatterFactory(
		...
		jPanel1Layout.setHorizontalGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
				.addGroup(jPanel1Layout.createSequentialGroup().addGap(166, 166, 166).addComponent(jLabel7).addGap(0, 0,
						Short.MAX_VALUE))
						...
						.addGroup(jPanel1Layout.createSequentialGroup()
								.addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
										.addGroup(jPanel1Layout.createSequentialGroup().addGroup(jPanel1Layout
												.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
												.addComponent(jLabel2).addComponent(jLabel8).addComponent(jLabel1)
												.addComponent(jLabel3).addComponent(jLabel4).addComponent(jLabel6)
												.addComponent(tfEmail).addComponent(tfNome).addComponent(tfCargo)
												.addComponent(jButton1, javax.swing.GroupLayout.Alignment.TRAILING))
												.addGap(46, 46, 46))
										.addGroup(jPanel1Layout.createSequentialGroup()
												.addComponent(tfSenha, javax.swing.GroupLayout.PREFERRED_SIZE, 1,
														Short.MAX_VALUE)
												.addGap(227, 227, 227)))
								.addGroup(jPanel1Layout
										.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
										.addComponent(cbDepartamento, 0, 159, Short.MAX_VALUE).addComponent(jLabel5)
										.addComponent(jLabel9).addComponent(cbPerfil, 0,
												javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
								.addGap(29, 29, 29))
						.addGroup(
								jPanel1Layout.createSequentialGroup()
										.addComponent(tfMatricula, javax.swing.GroupLayout.DEFAULT_SIZE, 153,
												Short.MAX_VALUE)
										.addGap(359, 359, 359))
						.addGroup(jPanel1Layout.createSequentialGroup()
								.addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
										.addComponent(lblVoltaCadUsuario).addComponent(tfCpf,
		...
		jPanel1Layout.setVerticalGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
				.addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
						...
						.addComponent(jButton1).addGap(9, 9, 9).addComponent(lblVoltaCadUsuario).addGap(46, 46, 46)));
